...
export default function CreateDispute() {
    ...
    const [orderId, setOrderId] = useState(""); // Simplified: text input for now, ideally a selection
    ...
    if (user?.role && user.role !== 'Buyer') {
        return (
            <div className="p-8 text-center">
                ...
                <Link href="/dashboard" className="text-indigo-600 hover:text-indigo-500 mt-4 inline-block">Back to Dashboard</Link>
            </div>
        )
    }
                ...
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="text-center">
                            <Link href="/dashboard" className="text-indigo-600 hover:text-indigo-500 text-sm">Cancel</Link>
                        </div>
                    </form>
                </div>
            </div>
